...
if (isset($_POST['buyerid']) && isset($_POST['orderbill'])){
	...
	$sqlorderdetails = "SELECT * FROM `tbl_orderdetails` INNER JOIN `tbl_item` ON tbl_orderdetails.item_id = tbl_item.item_id WHERE tbl_orderdetails.buyer_id = '$buyerid' AND tbl_orderdetails.order_bill = '$orderbill' AND tbl_orderdetails.seller_id = '$sellerid'";
}else{
    $sqlorderdetails = "NA";
}
