...
if (isset($_POST['sellerid']) && isset($_POST['orderbill'])){
	...
	$sqlorderdetails = "SELECT * FROM `tbl_orderdetails` INNER JOIN `tbl_item` ON tbl_orderdetails.item_id = tbl_item.item_id WHERE tbl_orderdetails.seller_id = '$sellerid' AND tbl_orderdetails.order_bill = '$orderbill'";
}
