...
import 'package:barterlt_v1/models/cart.dart';
import 'package:barterlt_v1/models/user.dart';
import 'package:http/http.dart' as http;
import 'package:barterlt_v1/myconfig.dart';
import 'package:barterlt_v1/views/screens/billscreen.dart';
                          ...
                          child: Row(
                            children: [
                              CachedNetworkImage(
                                ...
                                fit: BoxFit.cover,
                                imageUrl:
                                    "${MyConfig().SERVER}/barterit/assets/item/${cartList[index].itemId}.png",
